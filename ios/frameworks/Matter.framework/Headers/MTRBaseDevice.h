...
MTR_EXTERN NSString * const MTRValueDecodTypeKey MTR_AVAILABLE(ios(16.5), macos(13.4), watchos(9.5), tvos(16.5));
MTR_EXTERN NSString * const MTRNSDataDecodKey MTR_AVAILABLE(ios(16.5), macos(13.4), watchos(9.5), tvos(16.5));
MTR_EXTERN NSString * const MTRTlvValueType MTR_AVAILABLE(ios(16.5), macos(13.4), watchos(9.5), tvos(16.5));
...
MTR_AVAILABLE(ios(17.0), macos(14.0), watchos(10.0), tvos(17.0))
@interface MTRAttributeWriteRequest : MTRAttributeRequestPath <NSCopying, NSSecureCoding>

@property (nonatomic, readonly, copy, nullable) NSData * tlv;

+ (MTRAttributeWriteRequest *)requestPathWithEndpointID:(NSNumber * _Nullable)endpointID
                                                  clusterID:(NSNumber * _Nullable)clusterID
                                                attributeID:(NSNumber * _Nullable)attributeID
...
- (void)writeAttributeRequests:(NSArray<MTRAttributeWriteRequest *> * _Nullable)attributePaths
                   timedWriteTimeout:(NSNumber * _Nullable)timeoutMs
 ...
 */
- (void)customSubscribeToAttributePaths:(NSArray<MTRAttributeRequestPath *> * _Nullable)attributePaths
                       eventPaths:(NSArray<MTREventRequestPath *> * _Nullable)eventPaths
                           params:(MTRSubscribeParams * _Nullable)params
                            queue:(dispatch_queue_t)queue
                    reportHandler:(MTRDeviceResponseHandler)reportHandler
                subscriptionEstablished:(MTRSubscriptionEstablishedWithIdHandler _Nullable)subscriptionEstablished
          resubscriptionScheduled:(MTRDeviceResubscriptionScheduledHandler _Nullable)resubscriptionScheduled
    MTR_AVAILABLE(ios(16.4), macos(13.3), watchos(9.4), tvos(16.4));
